...
@interface WineskinLauncherAppDelegate : NSObject <NSApplicationDelegate>
{
    ...
    NSString *wine64Name;                             //the name of the Wine process we'll be launching
    NSString *wineStagingName;                             //the name of the Wine process we'll be launching
    NSString *wineStaging64Name;                             //the name of the Wine process we'll be launching
